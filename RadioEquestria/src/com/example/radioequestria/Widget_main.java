...
public class Widget_main extends AppWidgetProvider {
	...
	public void onEnabled(Context context) {
		...
		Toast.makeText(
				context,
				"Aplikacja RadioEquestria jest darmowa, jednak ³¹cz¹c siê za pomoc¹ sieci, mo¿e pobieraæ op³aty wed³ug taryfy operatora. Aby unikn¹æ wydatków, zalecamy ³¹czyæ siê poprzez WiFi.",
